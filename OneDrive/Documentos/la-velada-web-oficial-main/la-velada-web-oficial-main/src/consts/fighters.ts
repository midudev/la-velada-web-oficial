...
export const FIGHTERS: Fighters[] = [
  ...
  },
  {
    ...
    images: {
      profile: {
        front: '/boxers/perxitaa/profile/front.webp',
        side: '/boxers/perxitaa/profile/side.webp'
      },
      face: {
        front: '/boxers/perxitaa/face/front.webp',
        side: '/boxers/perxitaa/face/side.webp'
      },
      careo: '/boxers/perxitaa/careo.webp',
      combat: '/boxers/perxitaa/combat.webp'
    },
    gallery_images: [
      '/boxers/perxitaa/gallery/1.webp',
      '/boxers/perxitaa/gallery/2.webp',
      '/boxers/perxitaa/gallery/3.webp'
    ],
    socials: [
      {
        id: 'x',
  ...
  },
  {
    ...
    images: {
      profile: {
        front: '/boxers/abby/profile/front.webp',
        side: '/boxers/abby/profile/side.webp'
      },
      face: {
        front: '/boxers/abby/face/front.webp',
        side: '/boxers/abby/face/side.webp'
      },
      careo: '/boxers/abby/careo.webp',
      combat: '/boxers/abby/combat.webp'
    },
    gallery_images: [
      '/boxers/abby/gallery/1.webp',
      '/boxers/abby/gallery/2.webp',
      '/boxers/abby/gallery/3.webp'
    ],
    socials: [
      {
        id: 'x',
  ...
  },
  {
    ...
    clips: [
      ...
      },
      {
        ...
        url: 'https://www.youtube.com/embed/aOKOUIx8mPU?si=up7KtwZu2l3qEfmY&amp;clip=Ugkxf1_rx09dGrsr69Wdu2-Bi1wq8BvACp2f&amp;clipt=EPLYDBjYjA0'
      },
      {
        text: 'Me dijiste que era contra el Rubius. ¿Quién es ese?',
        url: 'https://www.youtube.com/embed/aOKOUIx8mPU?si=wsz9otQaciQnFKsV&amp;clip=UgkxGw6p-ksOymoiuVHBCw5Mx5UUmZqrAiY8&amp;clipt=EJycBxjRwwc'
      }
    ],
  },
  {
    ...
    clips: [
      ...
      },
      {
        ...
        url: 'https://www.youtube.com/embed/OjOItlQQHNM?si=JZx9yIQa0lXP9BTh&amp;clip=Ugkxjn97-DOruGG1ClS3KgmuiNEMXRf5a4ajY&amp;clipt=EJytRBjj4EQ'
      },
    ],
  },
  {
    ...
    clips: [
      {
        text: 'Yo voy a ir obviamente a ganar, y si no, es porque no ha acabado.',
  ...
  },
  {
    ...
    images: {
      profile: {
        front: '/boxers/alana/profile/front.webp',
        side: '/boxers/alana/profile/side.webp'
      },
      face: {
        front: '/boxers/alana/face/front.webp',
        side: '/boxers/alana/face/side.webp'
      },
      careo: '/boxers/alana/careo.webp',
      combat: '/boxers/alana/combat.webp'
    },
    gallery_images: [
      '/boxers/alana/gallery/1.webp',
      '/boxers/alana/gallery/2.webp',
      '/boxers/alana/gallery/3.webp',
      '/boxers/alana/gallery/4.webp',
      '/boxers/alana/gallery/5.webp'
    ],
    socials: [
      {
        id: 'instagram',
