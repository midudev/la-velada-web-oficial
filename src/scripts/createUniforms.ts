...
export function createUniforms(gl: WebGL2RenderingContext, canvas: HTMLCanvasElement, program: WebGLProgram): Uniforms {
	const basicUniforms = [
		...
		{ name: "iPrimary", fType: 3, defaultValue: [1, 1, 1, 1] },
		{ name: "iSecondary", fType: 3, defaultValue: [0, 0, 0, 0] },
		{ name: "iChannel0", fType: 5, defaultValue: [0] },
	]

	return basicUniforms.reduce((acumUnif, { name, fType, defaultValue }) => {
