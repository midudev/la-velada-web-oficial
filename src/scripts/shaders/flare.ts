// instrucciones del shader cada tipo son sus parametros
// uno de ellos es el color en sus valores red greenblue, generalmente el color se clampea a un valor entre 0 y 1
// pero valores superiores se pueden usar para evitar la atenuacion durante el proceso de generacion del texel
// generalmente se suele usar para generar colores emisivos que no reduzcan su luminosidad debido a la iluminacion.

export const flare = /* glsl */`
