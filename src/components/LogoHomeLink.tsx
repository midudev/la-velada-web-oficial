...
/** Shared with `Header.astro` script — menu open toggles this on `[data-header]`. */
export const HEADER_SELECTOR = '[data-header]'
export const HEADER_MOBILE_MENU_OPEN_ATTR = 'data-mobile-menu-open'

/** Crest SVG for this link only; hero uses `/public/logo.webp`. */
export const LOGO_CREST = {
  viewBox: '0 0 303 303',
  ...
  restFill: 'oklch(0.765 0.038 55.5)',
} as const

const LOGO_HOME_ARIA = 'La Velada del Año VI - Inicio'
