...
export const FIGHTERS: Fighters[] = [
  {
    ...
    description: 'Streamer español conocido por su enfoque metódico y su capacidad para mantener la calma bajo presión. Su técnica precisa y su habilidad para leer a sus oponentes lo convierten en un rival formidable en el ring.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Streamer con una personalidad carismática y una gran capacidad para entretener a su audiencia. Su enfrentamiento con Gaspi será una prueba de su habilidad y determinación en el ring.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Influencer con una fuerte presencia en redes sociales y una gran habilidad para generar controversia. Su combate con RoRo será uno de los más esperados de la velada, con una gran diferencia de altura entre ambas.',
    gender: 'femenino',
  ...
  },
  {
    ...
    description: 'Creadora de contenido con una gran autoestima y una actitud positiva. A pesar de la diferencia de altura con Abby, su determinación y entrenamiento la hacen una rival a tener en cuenta.',
    gender: 'femenino',
  ...
  },
  {
    ...
    description: 'Argentino conocido por su sentido del humor y su actitud relajada. Aunque no es un boxeador experimentado, su carisma y determinación lo convierten en un oponente formidable.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Creador de contenido mexicano dedicado al fútbol, conocido por su habilidad y carisma. Su rivalidad con Peereira7 ha generado gran expectación para su combate.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Fitness influencer con una impresionante masa muscular y una gran capacidad física. Su enfrentamiento con Carlos Belcast será una prueba de fuerza y resistencia en el ring.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Experimentado boxeador con varias participaciones en La Velada del Año. Su combate con Tomás Mazza será una prueba de su veteranía y habilidad en el ring.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Veterana de La Velada del Año, conocida por su habilidad y experiencia en el ring. Su enfrentamiento con Ari Geli será un duelo de titanes, con ambas peleadoras buscando demostrar su valía.',
    gender: 'femenino',
  ...
  },
  {
    ...
    description: 'Creador de contenido murciano con una gran trayectoria en el mundo del streaming. Su combate con Westcol será uno de los más esperados de la noche, con ambos peleadores buscando demostrar su valía.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Streamer colombiano con una gran presencia en plataformas de streaming. Su carisma y determinación lo convierten en un oponente formidable en el ring, siempre buscando demostrar su valía y superar sus límites.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Influencer y jugadora de baloncesto, conocida por su pasión y habilidad en la cancha. Su determinación y capacidad para superar obstáculos la convierten en una rival formidable en el ring.',
    gender: 'femenino',
  ...
  },
  {
    ...
    description: 'Argentino conocido por su K.O técnico en un evento anterior. Su enfrentamiento con Viruzz será una oportunidad para demostrar su valía y habilidad en el ring.',
    gender: 'masculino',
  ...
  },
  {
    ...
    description: 'Mexicano con experiencia en boxeo y una gran capacidad física. Su combate con Andoni promete ser uno de los más intensos de la noche, con una gran diferencia de peso entre ambos.',
    gender: 'masculino',
