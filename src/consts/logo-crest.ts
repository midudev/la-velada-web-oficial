/**
 * Header crest SVG — animated X in `LogoHomeLink`.
 * Hero / boxer selector use `/public/logo.webp` (marketing asset), not this path.
 */
...
export const LOGO_HOME_ARIA = 'La Velada del Año VI - Inicio'
